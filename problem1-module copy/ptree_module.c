...
int ptree(struct prinfo* buf, int* nr) {
  ...
  start_node = list_entry(&((&init_task)->children), struct task_struct, sibling);
  DFS(start_node, buf_in_kernel, &nr_in_kernel);//main procedure: do DFS search and link the buf_in_kernel in DFS order
